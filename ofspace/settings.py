"""
Django settings for ofspace project.
...
SECRET_KEY = 'django-insecure-ynpvvojy(ddkf^fx4msmt84!ast4%hnf)mo4txz@&=n_t74)0b'
...
WSGI_APPLICATION = 'ofspace.wsgi.application'
